...
const StepHeader = React.memo(({ fileName, setFileName, step }) => (
...
const Step1Form = React.memo(({ 
  ...
  writingPurpose, setWritingPurpose, 
  writingLevel, setWritingLevel, 
  wordCount, setWordCount, 
  addThesis, setAddThesis, 
  thesisDraft, setThesisDraft,
  errorMessage
}) => (
...
const AiGenerator = () => {
  ...
  const renderStep3 = () => (
    <ResultScreen 
      ...
      handleHumanizeAll={handleHumanizeAll}
  ...
  return (
    <main className="p-4 md:p-10">
      ...
      <div className="relative bg-white p-4 md:p-6 rounded-2xl border border-gray-200 shadow-sm w-full">
        <div className="absolute inset-0 rounded-2xl border-2 border-orange-400/60 -z-10" />

        <div className="relative">
          <StepHeader fileName={fileName} setFileName={setFileName} step={step} />
          {step === 1 && 
            <Step1Form 
              handleProceedToStep2={handleProceedToStep2}
              writingPurpose={writingPurpose} setWritingPurpose={setWritingPurpose}
              writingLevel={writingLevel} setWritingLevel={setWritingLevel}
              wordCount={wordCount} setWordCount={setWordCount}
              addThesis={addThesis} setAddThesis={setAddThesis}
              thesisDraft={thesisDraft} setThesisDraft={setThesisDraft}
              errorMessage={errorMessage}
            />
          }
          {step === 2 && 
            <Step2Form 
              handleProceedToStep3={handleProceedToStep3}
              aiTopics={aiTopics}
              selectedTopics={selectedTopics}
              handleTopicToggle={handleTopicToggle}
              fetchMoreTopics={fetchMoreTopics}
              handleUpdateCustomTopic={handleUpdateCustomTopic}
